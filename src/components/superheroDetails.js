  ...
  return (
    <div className="superhero-details">
      ...
      <div className="container-bio">
        <h2 className="stats-title">Biography</h2>
      ...
      <div className="details">
        <div className="container-appearance">
          <h2 className="stats-title">Appearance</h2>
        ...
        <div className="container-power">
          <h2 className="stats-title">Power Stats</h2>
        ...
        <div className="container-connections">
          <h2 className="stats-title">Connections</h2>
        ...
        <div className="container-work">
          <h2 className="stats-title">Work</h2>
